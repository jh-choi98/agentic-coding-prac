                    ...
                    switch (part.type) {
                      ...
                      case "dynamic-tool":
                        return (
                          <ToolInvocationBadge
                            ...
                            state={part.state === "output-available" || part.state === "output-error" ? "result" : part.state}
                          />
                        );
                      case "step-start":
                      ...
                      default:
                        if (typeof part.type === "string" && part.type.startsWith("tool-")) {
                          const p = part as { type: string; toolCallId?: string; input?: unknown; state?: string };
